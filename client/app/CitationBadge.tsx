    ...
    return (
      <div className="flex flex-wrap gap-2 mt-3">
        {citations.map((citation, idx) => (
          <div
            key={idx}
            className="inline-flex items-center gap-2 px-3 py-1 bg-[rgba(100,200,255,0.15)] border border-[rgba(100,200,255,0.3)] rounded-full text-xs text-blue-300 hover:bg-[rgba(100,200,255,0.25)] transition cursor-default"
    ...
    <div className="mt-4 pt-4 border-t border-[rgba(255,255,255,0.08)]">
      ...
      <div className="space-y-2">
        {citations.map((citation, idx) => (
          <div
            key={idx}
            className="flex items-start gap-2 p-2 bg-[#1a1a1a] rounded border border-[rgba(255,255,255,0.08)] text-xs text-gray-400"
          >
            <span className="text-base flex-shrink-0">📄</span>
            <div className="flex-1">
              <p className="font-medium text-gray-300">{citation.filename}</p>
